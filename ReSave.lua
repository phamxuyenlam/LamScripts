...
local resaveversion = "2.26.upg2.3"
...
do
	...
	if not logButton:GetAttribute("ReSaveLogBound23") then
		logButton:SetAttribute("ReSaveLogBound23", true)
		logButton.MouseButton1Up:Connect(function()
	...
	if not logClear:GetAttribute("ReSaveLogClearBound23") then
		logClear:SetAttribute("ReSaveLogClearBound23", true)
		logClear.MouseButton1Up:Connect(function()
	...
	if not logClose:GetAttribute("ReSaveLogCloseBound23") then
		logClose:SetAttribute("ReSaveLogCloseBound23", true)
		logClose.MouseButton1Up:Connect(function()
			logConsole.Visible = false
	...
	ReSaveLog(
		"INFO",
		"STARTUP",
		"ReSave v2.26.upg2.3 initialized",
