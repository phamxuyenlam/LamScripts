...
local function C_49()
    ...
    local injected = root.Injected.Value
    ...
    buttons.Execute.MouseButton1Up:Connect(function()
        ...
        task.spawn(function()
            ...
            if not ok then
                warn("ReSave execute failed:", err)
    ...
    buttons.Maximize.MouseButton1Up:Connect(function()
        -- Reserved for the later Rayfield-inspired window pass.
    end)
...
local function C_51()
    ...
    local function normalizeName(value)
        ...
        -- Preserve a final .lua exactly; append .lua to every other name.
        -- Example: test.json -> test.json.lua
